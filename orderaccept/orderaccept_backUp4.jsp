	...
	<table>
		<tr>
			...
			<td style="background-color: white;">
				<!-- 対応画面詳細  --> &nbsp;&nbsp;&nbsp;注文 <br> <img
				style="width: 300px; height: 8px;" src="images/Que.jpg"
				alt="Billiards Cafe Tres">
				<form id="myForm" action="orderaccept" method="post">
					日付:&nbsp;
					<input size="4" type="text" name="year" value="${orderAccept.year}">
					年&nbsp;
					<input size="2" type="text" name="month"
						value="${orderAccept.month}">
					月&nbsp;
					<input size="2" type="text" name="day" value="${orderAccept.day}">
					日<br> 名前:&nbsp;
					<input size="15" type="text" name="name"
						value="${orderAccept.name}">
					<br> 注文メニュー:&nbsp; <select name="selectedOrderName">
					...
					<br>
					<input type="button" name="action" value="決定"
						onclick="confirmAndSubmit(); return false;">
					<input type="button" name="action" value="メニュー検索"
						onclick="submitForSearch()">
					<input id="action" type="hidden" name="action" value="">
					<!-- hidden -->
					<%-- 注文確認画面から変更ボタンを選択された時に設定して画面遷移する.--%>
					<input type="hidden" name="updateFl"
						value="${orderAccept.updateFl}">
